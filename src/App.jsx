    ...
    <div className="w-full min-h-screen bg-[#FAF9F6] text-[#0C1D13] antialiased font-sans">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          <div className="flex items-center gap-4">
            {/* Mobile Menu Btn (Moved to Left) */}
            <button
              onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)}
              className="md:hidden text-[#FAF9F6] hover:text-[#4CAF50] transition-colors p-1 -ml-2"
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-50px" }} id="economics" className="bg-[#FAF9F6] py-16 md:py-24 border-b border-[#2E7D32]/10 text-left">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="flex overflow-x-auto md:grid md:grid-cols-3 gap-6 md:gap-8 snap-x snap-mandatory pb-8 -mx-6 px-6 md:mx-0 md:px-0 [&>div]:min-w-[85vw] md:[&>div]:min-w-0 [&>div]:snap-center scrollbar-hide scroll-smooth">
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-50px" }} id="team" className="bg-[#0C1D13] text-[#FAF9F6] py-16 md:py-24 border-b border-[#2E7D32]/20 text-left">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <motion.div variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }} className="flex overflow-x-auto sm:grid sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 items-stretch snap-x snap-mandatory pb-8 -mx-6 px-6 sm:mx-0 sm:px-0 [&>div]:min-w-[85vw] sm:[&>div]:min-w-0 [&>div]:snap-center scrollbar-hide scroll-smooth">
            {/* Team Member 1 */}
