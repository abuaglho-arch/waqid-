...
export default function App() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#FAF9F6] text-[#0C1D13] antialiased font-sans">
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="crisis" className="bg-[#FAF9F6] py-16 md:py-24 border-b border-[#2E7D32]/10 text-left">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="mt-16 bg-[#F0EFEA] p-8 rounded-2xl border border-[#2E7D32]/10 flex flex-col md:flex-row gap-6 justify-between items-start md:items-center">
            <div className="max-w-3xl">
              ...
              <div className="text-xs md:text-sm text-[#0C1D13]/75 font-sans leading-relaxed">
                ...
                <p className="block md:hidden">
                  Farmers are trapped by costly synthetic fertilizers, while immense agricultural waste is burned nearby. By closing this logic gap, the waste of our fields becomes the restoration of our soil and the fuel for our industries.
                </p>
              </div>
            </div>
            <button 
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="solution" className="bg-[#F0EFEA] py-16 md:py-24 border-b border-[#2E7D32]/10 text-left">
        <div className="max-w-7xl mx-auto px-6">
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="economics" className="bg-[#FAF9F6] py-16 md:py-24 border-b border-[#2E7D32]/10 text-left">
        <div className="max-w-7xl mx-auto px-6">
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="partnerships" className="bg-[#0C1D13] text-[#FAF9F6] py-16 md:py-24 text-left relative overflow-hidden border-b border-[#2E7D32]/20">
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="environment" className="bg-[#0C1D13] py-16 md:py-24 relative overflow-hidden border-b border-[#2E7D32]/10">
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="impact" className="bg-[#FAF9F6] py-16 md:py-24 border-b border-[#2E7D32]/10 text-left">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="text-xs font-sans font-bold uppercase tracking-widest text-[#2E7D32]">
              R&D Roadmap
      ...
      {/* THE ORIGIN STORY */}
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="origin" className="bg-[#FAF9F6] py-16 md:py-24 border-b border-[#2E7D32]/10 text-left">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="text-xs font-sans font-bold uppercase tracking-widest text-[#2E7D32]">
              The Origin
      ...
      {/* TEAM & ADVISORS */}
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="team" className="bg-[#0C1D13] text-[#FAF9F6] py-16 md:py-24 border-b border-[#2E7D32]/20 text-left">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="text-xs font-sans font-bold uppercase tracking-widest text-[#4CAF50]">
              The Human Capital
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="gallery" className="bg-[#F0EFEA] py-16 md:py-24 border-b border-[#2E7D32]/10 text-left">
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-xl mx-auto mb-16">
            <span className="text-xs font-sans font-bold uppercase tracking-widest text-[#2E7D32]">
              Visual Timeline
      ...
      <motion.section variants={sectionReveal} initial="initial" whileInView="whileInView" viewport={{ once: true, margin: "-10px" }} id="contact-section" className="bg-[#FAF9F6] py-16 md:py-24 text-left">
        <div className="max-w-7xl mx-auto px-6">
